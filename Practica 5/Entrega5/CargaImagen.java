...
public class CargaImagen {
    ...
    public static int[][] cargar(String fichero) throws IOException{
        ...
        for(int i = 0 ; i < imagen.getHeight() ; ++i)
        {
            for(int j = 0 ; j < imagen.getWidth() ; ++j)
            {
                ...
                matriz[i][j] = (int) ((c.getRed() + c.getGreen() + c.getBlue()));
            }
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        ConvertirAGris("FotoPrueba.png", "FotoPrueba_gris.png");
        
        System.out.println("Cargando fichero en matriz");
        int[][] matriz = cargar("FotoPrueba_gris.png");
        
        System.out.println("Guardando matriz en fichero");
        guardar(matriz, "FotoPrueba_gris_procesada.png");
    }
}
